...
export const events = [
  {
    ...
    points: {
      en: [
        ...
        { text: 'Rack of lamb with peaches and a lavender-infused lamb jus', price: 'EUR 26' },
      ...
      lv: [
        ...
        { text: 'Jēra karē ar persikiem un jēra sulas–lavandas mērci', price: '26 EUR' },
      ...
      fr: [
        ...
        { text: 'Carré d’agneau aux pêches, jus d’agneau parfumé à la lavande', price: '26 €' },
      ...
      ru: [
        ...
        { text: 'Каре ягнёнка с персиками под соусом на основе сока ягнёнка с лавандой', price: '26 EUR' },
